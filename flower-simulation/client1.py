...
# Skenario dimana Klien 1 mendapatkan lebih banyak data Normal / Aman (indeks 0)
dist = [4000, 100] # [Kelas 0 : Normal, Kelas 1 : DDoS]
...
if __name__ == "__main__":
    ...
    plotClientData(results_list, "Klien 1")