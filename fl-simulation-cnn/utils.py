...
RESULTS_DIR = "/app/fl-simulation-cnn/results"
...
def build_model(n_features):
    ...
    x = layers.Conv1D(64, 3, activation="relu", kernel_initializer="he_normal", padding="same")(inp)
...
def get_params(model):    return model.get_weights()
