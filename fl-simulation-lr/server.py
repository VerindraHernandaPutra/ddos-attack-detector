...
if __name__ == "__main__":
    ...
    pd.DataFrame(history).to_csv(
        os.path.join("results", "lr_server_history.csv"), index=False)
    save_round_plot(history, "lr_server")
    save_confusion_matrix(y_test, global_model.predict(X_test), "lr_global")
